...
<body>
	...
	<header id="header">
		...
		<div id="nav-container">
				...
				<h1><a id="logo" href="index.php">Logo</a></h1>
...
<div class="grid-container-playlist">
            ...
            // Altrimenti stampiamo le playlist corrispondenti, recuperando i link dal database con una query
          ...
          for($i = 0; $i < count($generi); $i++) {
            ...
            echo "<div class='grid-item'><iframe src='$riga[link]' width='300' height='380' allow='encrypted-media'></iframe>
                  <br><br><a style='font-size:15px; color:black;' href='$riga[link]' target='_blank'> Maggiori informazioni </a></div>";
                }
          }
    }
