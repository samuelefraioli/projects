...
// Controllo se l'utente è loggato
		if(isset($_SESSION['username'])){
			...
			// benvenuto
			echo "<p style='color:black;'>Benvenuto " .$_SESSION['username']."</p>";
			// solo per admin: se sono presenti dei feedback di aggiunta o eliminazione, li stampa.
			if(isset($_SESSION['feedback'])){
				echo "<p style='color:orange;'>".$_SESSION['feedback']. "</p>";
				$_SESSION['feedback']="";
			}
       ...
       echo "<form action='admin.php' method='post'>
			       <p style='color:black;'>Aggiungi una playlist:</p><input type='text' name='nome' placeholder='nome'><input type='url' name='link' placeholder='link'>
			       ...
			       <input type='submit' value='Aggiungi playlist'></form><br><br>";
      ...
      echo "<option name='rimuovi' value='";
		  ...
		  echo  "</select>";
			echo	"<input type='submit' value='Rimuovi playlist'></form><br><br>";
       ...
       echo "<div style='float:left;display:block;'><form action='risultato.php' method='get'>
             <label for='cerca' style='color:black;'>Cerca per parola chiave</label><br><br>
